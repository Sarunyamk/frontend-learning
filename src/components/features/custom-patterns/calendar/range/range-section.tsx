...
import { DateRangePreview } from './range-preview';

const sourcePattern = CALENDAR_PATTERNS.find((p) => p.key === 'range')!;
const usagePattern = CALENDAR_PATTERNS.find((p) => p.key === 'range-usage')!;
