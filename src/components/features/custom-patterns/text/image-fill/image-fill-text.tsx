...
import { ImageFillTextPreview } from './image-fill-text-preview';

const pattern = TEXT_PATTERNS.find((p) => p.key === 'image-fill')!;
const usagePattern = TEXT_PATTERNS.find((p) => p.key === 'image-fill-usage')!;

export function ImageFillText() {
  return (
