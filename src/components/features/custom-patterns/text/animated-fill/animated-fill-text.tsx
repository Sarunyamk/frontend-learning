...
import { AnimatedFillTextPreview } from './animated-fill-text-preview';

const pattern = TEXT_PATTERNS.find((p) => p.key === 'animated-fill')!;
const usagePattern = TEXT_PATTERNS.find((p) => p.key === 'animated-fill-usage')!;
