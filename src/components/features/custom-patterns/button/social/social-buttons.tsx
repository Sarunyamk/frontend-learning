...
const SOCIAL_EXAMPLES = [
  {
    pattern: BUTTON_PATTERNS.find((p) => p.key === 'social-google')!,
    preview: (
  ...
  {
    pattern: BUTTON_PATTERNS.find((p) => p.key === 'social-github')!,
    preview: (
      <Button className="bg-[#24292F] text-white hover:bg-[#1B1F23] dark:bg-white dark:text-[#24292F] dark:hover:bg-gray-200">
        <svg className="mr-2 size-4" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    pattern: BUTTON_PATTERNS.find((p) => p.key === 'social-facebook')!,
    preview: (
      <Button className="bg-[#1877F2] text-white hover:bg-[#0C63D4]">
        <svg className="mr-2 size-4" viewBox="0 0 24 24" fill="currentColor">
